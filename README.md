...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-21 10:41`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/72f18c99-10de-41de-ab5d-d9bc5b769ca2.git
$ cd 72f18c99-10de-41de-ab5d-d9bc5b769ca2
```
